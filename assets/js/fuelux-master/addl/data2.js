(function (root, factory) {
	if (typeof define === 'function' && define.amd) {
		...
		root.sampleData2 = factory();
	}
}(this, function () {
	
  var object2;
	$.ajax({
		url:'/kamahalan/index.php/post/myformsjson',
		async : false,
	...
	return({"geonames2":object2});
//dataarray.geonames.push("jeth":"jeth");	
 //console.log (dataarray);
	/*return{
		...
		"geonames": [{
			...
			"lng": -71.0597732,
			"fcode": "PPLA",
			"geonameId": <a class='btn edit'>Edit</a><input >,
			"lat": 42.3584308,
			"population": 617594
		}]
	}*/
