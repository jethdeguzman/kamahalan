...
<html lang="en" class="fuelux">
    ...
    <script src="<?php echo base_url();?>assets/js/fuelux-master/addl/datasource.js" type="text/javascript"></script>
        <script src="<?php echo base_url();?>assets/js/fuelux-master/addl/data.js" type="text/javascript"></script>
...
<table id="allformsgrid" class="table table-bordered table-hover datagrid">
 <thead>
 <tr>
